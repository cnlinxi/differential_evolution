...
class rlde(DECurrentToPBest1Bin):
    def __init__(self,n_features=30,*args, **kwargs): # n_features: 个体向量维数
        kwargs['f'] = 0.5
        kwargs['cr'] = 0.5
        ...
        self.n_actions=6 # 动作个数
        self.actions=list(range(self.n_actions))
        self.action=np.random.choice(self.actions)
        self.n_features = n_features
        self.dqn=DQNAgent(state_size=n_features,action_size=self.n_actions)
    ...
    def update_cr_f1(self):
        self.f=1.0
        self.cr=0.9
    def update_cr_f2(self):
        self.f=1.0
        self.cr=0.1
    def update_cr_f3(self):
        self.f=0.8
        self.cr=0.2
    ...
    def generateTrialMember(self, i):
        ...
        mutant=strategy['algorithm'].mutation(self,i,self.f)
        trialMember=strategy['algorithm'].crossover(self,i,mutant,self.cr)
        # print('f:',self.f)
        # print('cr:',self.cr)
        return trialMember
    ...
    def optimise(self):
        ...
        while self.terminationCriterion() == False:
            ...
            print(f'Evaluation:{self.functionEvaluations}, Current Cost:{np.mean(self.population.costs)}')
